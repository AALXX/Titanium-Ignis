...
export const MetricCard = ({ title, value, change, currency = '', changeType = 'neutral', icon: Icon, iconColor = 'text-cyan-400' }: MetricCardProps) => {
        ...
        <div className="rounded-xl border border-[#4d4d4d] bg-[#0303035b] bg-gradient-to-br p-6 text-gray-50 shadow-sm transition-all duration-300 ease-out hover:shadow-[0_0_40px_rgba(34,211,238,0.3)]">
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    ...
                    <h3 className="mb-1 text-3xl font-bold text-gray-50">{value}{formatCurrency(currency)}</h3>
